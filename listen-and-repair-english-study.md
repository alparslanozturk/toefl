TOEFL 2026 "Listen & Repeat" Tam Çalışma Paketi

Bu çalışma rehberi, Kıdemli bir Dil Eğitim Teknolojisi Uzmanı ve TOEFL Müfredat Tasarımcısı gözüyle, 21 Ocak 2026 itibarıyla yürürlüğe giren yeni TOEFL iBT formatındaki "Listen & Repeat" (Dinle ve Tekrar Et) görevine yönelik olarak hazırlanmıştır. Bu paket, sadece dilbilgisi doğruluğunu değil; aynı zamanda TOEFL'ın yapay zeka tabanlı puanlama sisteminin (AI Scoring Engine) ölçtüğü prosodi, düşünce grupları (thought groups) ve işlevsel kelimelerin (function words) doğru telaffuzu gibi teknik nüansları da içermektedir.

1. Kullanıcı Başlangıç Komutu (Prompt)
...
Tema 16: Kampüste Yemek (Campus Dining)
...
* Vegetarian and gluten-free meals are clearly labeled at each station.
* Different meals are displayed at the counter.
* Affordable prices are shown on the menu.
* Payment is completed at the front counter.
* Busy periods usually occur around noon.
...
Tema 18: Akademik Dersler ve Çalışma Alışkanlıkları (Lectures & Study Habits)

* The lecture begins on time.
* Students sit in rows.
* Regular practice supports learning.
* Slides, charts, and graphs are shown.
* Key points are explained clearly.
* Many learners set aside time to review course materials.
* Important terms are repeated for clarity.
* Visual materials help explain complex concepts.
* The instructor pauses to check understanding.
* Organized study schedules help students stay focused and prepared.
* Information is presented in a structured sequence.
* Complex topics are explained using examples with clear comparisons.
* Effective study routines allow students to balance coursework and other responsibilities.
* Developing strong study habits helps students succeed academically throughout an entire university semester.

Tema 19: Teknoloji Konferansları (Tech Conferences)
...
Tema 20: Kariyer Forumları (Career Forums)
...
* Near the center of the hall, career advisers help students review their resumes.
* This area allows students to receive useful feedback on their application materials.
* Recruiters sometimes meet promising students for brief screening interviews.
* Attending the forum is strongly recommended for students who are planning their future careers.

Tema 21: MBA Tanıtım Günleri ve Akademik Danışmanlık (MBA & Advising)

* This is an MBA open house event.
* The event is held at the business school campus.
* Advisors meet students to plan their academic paths.
* The registration desk is located near the entrance area.
* At the registration desk, visitors receive name tags and event materials.
* Academic advisors help students understand graduation requirements.
* The event information board displays the map and schedule.
* In the networking lounge, guests can meet current MBA students.
* Advising sessions help students make informed academic decisions.
* The presentation hall hosts several information sessions throughout the day.
* During these sessions, speakers introduce the MBA curriculum and career paths.
* Students should prepare a list of questions before the meeting begins.
* Attending an open house can be a helpful step when deciding whether to apply to an MBA program.

Tema 22: Kütüphane Hizmetleri (Library Services)

* Welcome to the city library.
* Please speak quietly inside.
* The library offers various services.
* Students use library resources daily.
* The catalog terminals are near the entrance.
* Library cards can be issued with a valid ID.
* The library provides access to academic materials.
* Online databases help students locate reliable academic sources.
...
* During upgrades, you will not be able to renew books or place holds online.

Tema 23: Alışveriş ve Sosyal Alanlar (Shopping)

* Shops open at 10:00 in this mall.
* Many people meet friends in the central plaza.
* Escalators near the entrance take visitors to the upper level.
* Most clothing stores are located along the main corridor.
* The food court upstairs offers many quick meal options.
* Visitors often sit outside restaurants in the terrace area.
* Information screens near the escalator help visitors find stores quickly.
* Please keep your receipt in case you need to return an item.
* The store offers a variety of branded apparel and accessories.
* Clothing sizes are available in different ranges.

Tema 24: Seyahat ve Havaalanı Güvenliği (Travel & Security)

* Welcome to the international airport.
* Baggage claim is straight ahead.
* Passengers check in at the counters.
* Travelers wait near the departure gates.
* Security officers check bags before passengers enter the gate area.
* Please have your boarding passes and identification ready for security.
* Information screens show updated departure times for all flights.
* Carry-on liquids must be placed in clear plastic bags.
* Laptops must be placed in separate trays for screening.
...
Puan	Açıklama
5	Kusursuz Tekrar: Tam anlaşılırlık. Eksik veya değişmiş kelime yok. Doğal prozodi (vurgu/tonlama).
4	Küçük Hatalar: Anlam korunmuş ancak artikeller (a, an, the) veya edatlarda küçük sapmalar var.
3	Kısmi Kayıp: Anahtar kelimelerden bazıları değişmiş veya eksik. Anlam biraz bozulmuş olabilir.
2	Parçalı Yanıt: Cümlenin büyük kısmı eksik. Konuşma tereddütlü ve anlaşılması zor.
1	Yetersiz Yanıt: Sadece birkaç kelime tanınabiliyor. Cümle bütünlüğü yok.
0	Yanıt yok veya tamamen anlamsız sesler.

Kritik Zamanlama Bilgisi (Memorize This!)

Sınavda her cümle için farklı süreleriniz vardır. Sinyal sesinden sonra şu süreleri takip edin:

* Cümle 1-2 (Kısa): 8 Saniye
* Cümle 3-5 (Orta): 10 Saniye
* Cümle 6-7 (Uzun): 12 Saniye

5 Profesyonel Telaffuz Tuzağı

1. Makale Tuzağı (The Article Trap): Test katılımcılarının %12'si "a, an, the" kelimelerini düşürdüğü için puan kaybeder. Bu küçük kelimeler dilbilgisi değil, AI için "doğruluk" göstergesidir.
2. Düşünce Grupları (Thought Groups): "Although" veya "Because" gibi bağlaçlardan sonra doğal bir duraksama yapın. Cümleyi kelime kelime değil, anlam grupları halinde söyleyin.
3. İşlevsel Kelimeler (Function Words): "Is, at, for, of" gibi kelimeleri vurgulamayın (reduce them), ancak asla tamamen yutmayın.
4. Sondaki -s ve -ed Ekleri: "Two books" yerine "Two book" demek veya geçmiş zaman ekini düşürmek doğrudan puan kaybıdır.
5. Düz Tonlama (Flat Intonation): İngilizce vurgu temelli (stress-timed) bir dildir. Sesiniz robot gibi dümdüz olmamalı, doğal bir ritimle yükselip alçalmalıdır.

Uzman Onaylı: 3 Adımlı Gölge Yöntemi (Shadowing)

1. Metinle Dinle: Önce metne bakarak dinleyin; vurguların nereye düştüğünü ve kelimelerin nasıl bağlandığını (linking) görün.
2. %90 Hız Kuralı: İlk denemelerde hızı %90'a çekerek sadece dudak ve çene hareketlerinizi hoparlördeki sesle eşleştirin.
3. Kaydet ve Karşılaştır: Kendi sesinizi kaydedin. Orijinal sesle aranızdaki fark "gelişim alanınızı" gösterir. Kelime hatası yaparsanız durmayın, devam edin; sessizlik hatadan daha çok puan kırar.
